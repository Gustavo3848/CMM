...
class ClinicaController extends Controller
{
    ...
    public function actionView($id)
    {
        return $this->render('view', [
            'medico' => $this->MedicoHasClinica($id),
            'especialidades' => $this->EspecialidadesHasClinica($id),
    ...
    protected function MedicoHasClinica($id){
        ...
        ->select(['*'])
        ->from('Medico')
        ->where(['Medico_id' =>$Medicos])
        ->all();
        return $rows;
    }
    protected function EspecialidadesHasClinica($id){
