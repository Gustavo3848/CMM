...
use app\models\MedicoHasEspecialidadesSearch;
...
class MedicoHasEspecialidadesController extends Controller
{
    ...
    public function findByIdMedico($Medico_id){
        $ids = MedicoHasEspecialidades::findAll(['Medico_id'=> $Medico_id]);
        $clinicas = clinica::findAll(['Clinica_id' => $ids]);
        return $clinicas;
    }
}
